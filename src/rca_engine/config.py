...
class Settings:
    ...
    rag_embedding_provider: str = _env("RAG_EMBEDDING_PROVIDER", default="hash")
    rag_embedding_api_url: str = _env(
        "RAG_EMBEDDING_API_URL",
        default="https://api.openai.com/v1/embeddings",
    )
    rag_embedding_api_key: str = _env("RAG_EMBEDDING_API_KEY", "OPENAI_API_KEY", "")
    rag_embedding_model: str = _env("RAG_EMBEDDING_MODEL", default="text-embedding-3-small")
    ...
    llm_model: str = _env("LLM_MODEL", "RAG_LLM_MODEL", "gpt-5.4-mini")
